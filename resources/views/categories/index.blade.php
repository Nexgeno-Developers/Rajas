...
@section('content')
	...
	<div class="col-md-6"><a href="{{ route('categories.create') }}" class="add-new-employee btn btn-secondary pull-c-right"> <span class="fa fa-plus mr-1"></span> {{__("Create Category")}}</a></div>
</div>
